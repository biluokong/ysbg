package com.biluo.wechat.service.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.biluo.model.wechat.Menu;
import com.biluo.vo.wechat.MenuVo;
import com.biluo.wechat.mapper.MenuMapper;
    ...
    public void syncMenu() {
        ...
        for(MenuVo oneMenuVo : menuVoList) {
            ...
            if(CollectionUtils.isEmpty(oneMenuVo.getChildren())) {
                ...
                one.put("url", "http://web02.xxx.xxx:8800/#"+oneMenuVo.getUrl());
            } else {
                ...
                for(MenuVo twoMenuVo : oneMenuVo.getChildren()) {
                    ...
                    if(twoMenuVo.getType().equals("view")) {
                        ...
                        //H5页面地址
                        view.put("url", "http://web02.xxx.xxx:8800#"+twoMenuVo.getUrl());
                    } else {
                        view.put("name", twoMenuVo.getName());
